...
class SenetivityKnob extends StatefulWidget {
  final double volume;
  final ValueChanged<double>? onVolumeChanged;
  final double size;

  const SenetivityKnob({
    super.key,
...
class VerticalVolumeKnobState extends State<SenetivityKnob>
  ...
  @override
  void didUpdateWidget(SenetivityKnob oldWidget) {
    ...
    final centerPaint =
        Paint()
          ..shader = RadialGradient(
            colors: [Colors.grey.withOpacity(0.2), Colors.greenAccent],
            stops: [0.85, 1.0],
